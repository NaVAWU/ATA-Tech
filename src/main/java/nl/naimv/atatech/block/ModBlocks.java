...
import nl.naimv.atatech.block.custom.*;
...
public class ModBlocks {
    ...
    public static final Block GRATE_TEST = registerBlock("grate_test",
            new GrateTestBlock(FabricBlockSettings.of(Material.METAL).strength(8f).requiresTool()),ModItemGroup.ATATECH);
